...
# Implementation copied from public code for "FedBE: Making Bayesian Model Ensemble Applicable to Federated Learning" 
# (Chen and Chao 2021)
# Link to code (publically available) is in that paper

# stochastic weighted average optimizer
class SWA(Optimizer):
